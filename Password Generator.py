...
class MainWindow:
    ...
    def widgets(self):
        ...
        self.copyPwd = tk.Button(self.main, text="Copy Password", width=25, command = self.copyPassword)
        ...
        self.mainWidgets = [self.frame, self.genPwd, self.copyPwd, self.viewHistory, self.textBox]
    ...
    def generatePassword(self):
        ...
        self.generated_password = ''.join(randomGen)
